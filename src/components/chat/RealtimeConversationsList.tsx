...
interface RealtimeConversationsListProps {
...
export const RealtimeConversationsList: React.FC<RealtimeConversationsListProps> = ({
  channelId,
  activeConversation,
  onConversationSelect,
  isDarkMode
}) => {
  const { conversations, loading, error } = useRealtimeConversations(channelId);
