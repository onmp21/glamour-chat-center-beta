...
import { useRecentActivitiesRealtime } from '@/hooks/useRecentActivitiesRealtime';

interface RecentActivitiesSectionRealtimeProps {
  isDarkMode: boolean;
}

export const RecentActivitiesSectionRealtime: React.FC<RecentActivitiesSectionRealtimeProps> = ({ 
  isDarkMode 
}) => {
  const { activities, loading } = useRecentActivitiesRealtime();
