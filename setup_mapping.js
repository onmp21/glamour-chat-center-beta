...
var EvolutionMessageService_1 = require("./src/services/EvolutionMessageService");
function setupChannelMapping() {
    return __awaiter(this, void 0, void 0, function () {
        var testMapping, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, EvolutionMessageService_1.evolutionMessageService.createOrUpdateChannelMapping(testMapping)];
                case 1:
                    result = _a.sent();
                    if (result.success) {
